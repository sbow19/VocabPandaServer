    ...
    static addNewUserDetails(userCredentials: appTypes.UserCredentials, userId: string): Promise<appTypes.DBAddUserResponseObject<appTypes.DBAddUserResponseConfig>>{
        ...
        return new Promise(async(resolve, reject)=>{
            ...
            try{
                ...
                const connectionResponseObject: appTypes.DBResponseObject<appTypes.DBResponseObjectConfig> = await super.getUsersDetailsDBConnection(); //Get connection to user_logins table
