...
class EmailVerificationChecker {
    ...
    static CheckUnverifiedEmails(){
        ...
        return new Promise(async(resolve, reject)=>{
            ...
            const emailVerificationResponse: appTypes.EmailVerificationResponse = {
            ...
            try{
                ...
                try{
                    ...
                    const [queryResults] = await dbConnectionObject.mysqlConnection?.query(
                        checkUnverifiedEmailsSqlQuery,
                        currentTime
                    );
                ...
                const EmailVerificationError = new Error(
                    "Unable to check unverified emails."
                );
